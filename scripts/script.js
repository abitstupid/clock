...
function showTime() {
    ...
    function changeImage() {
        if( toggleCheckbox.checked && ((hours > 17 && hours <= 23) || (hours >=0 && hours <5) )) {
            visualAidContainer.style.background = "url(../clock/images/night.jpg) var(--secondary-color)";
            ...
            visualAidContainer.style.background = "url(../clock/images/day  .jpg) var(--secondary-color)";
            visualAidContainer.style.backgroundSize = "cover";
            visualAidContainer.style.backgroundPosition = "center";
            visualAidContainer.style.backgroundRepeat = "repeat";
        }   
    ...
    function changeImageMobile() {
        if (document.body.scrollWidth <781) {
            ...
            if( toggleCheckbox.checked && ((hours > 17 && hours <= 23) || (hours >=0 && hours <5) )) {
                body.style.background = "url(../clock/images/night.jpg) var(--secondary-color)";
                body.style.backgroundSize = "cover";
                body.style.backgroundPosition = "center";
                body.style.backgroundRepeat = "repeat";
            
            } else if (!toggleCheckbox.checked && (((hours>5 && session == "PM") && (hours<=11 && session == "PM"))|| (hours>=12 && session == "AM") && (hours<=5 && session == "AM"))){
                body.style.background = "url(../clock/images/night.jpg) var(--primary-color)";
                body.style.backgroundSize = "cover";
                body.style.backgroundRepeat = "repeat";
                body.style.backgroundPosition = "center";
            } else {
                body.style.background = "url(../clock/images/day-mobile.jpg) var(--primary-color)";
                body.style.backgroundSize = "cover";
                body.style.backgroundRepeat = "repeat";
                body.style.backgroundPosition = "center";
            }
            ...
            body.style.background = "url(../clock/images/bg-clock.jpg) var(--primary-color)";
            body.style.backgroundSize = "cover";
            body.style.backgroundRepeat = "repeat";
            body.style.backgroundPosition = "center";
    }   
